...
<p/>
---
As a derivate work of [Llama-2-13b](https://huggingface.co/meta-llama/Llama-2-13b) by Meta,
this demo is governed by the original [license](https://huggingface.co/meta-llama/llama-2-13b/blob/main/LICENSE.txt) and [acceptable use policy](https://huggingface.co/meta-llama/llama-2-13b/blob/main/USE_POLICY.md).
"""
...
chat_interface = gr.ChatInterface(
    fn=generate,
    additional_inputs=[
        gr.Textbox(label="System prompt", lines=6, value="""You are an artificial intelligence assistant that gives helpful, detailed, and polite response to the human user."""),
        gr.Slider(
